...
WebUI.click(findTestObject('Page_Masuk untuk dapatkan akses di Coding.ID/a_Buat akun'))

WebUI.click(findTestObject('Page_Buat akun dan dapatkan akses di Coding.ID/span_Buat Akun Baru'))
