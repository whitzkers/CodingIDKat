...
WebUI.sendKeys(findTestObject('Object Repository/Page_Online event bersertifikat dari prakti_f42b96/input_Events_searchInputEvent'), 
    Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Online event bersertifikat dari prakti_f42b96/h4_Day 3 Predict using Machine Learning'), 
